...
public class MainServlet extends HttpServlet{
	...
	throws ServletException, IOException{
		...
		out.println("<html>");
		out.println("<body>");
		out.println("<h2>Hello there, here is our third web app running on the new WildFly Server <br>");
		out.println("Using a context root configuration to change the Application URI<br>");
		out.println("And using the virtual host app1-v03.mydomain.com to access our application, see below some configurations!</h2>");
		...
		out.println("<br><b>WildFly Context Root: /</b>");
		out.println("</body>");
		out.println("</html>");	
	}
