...
public class MainServlet extends HttpServlet{
	...
	throws ServletException, IOException{
		...
		out.println("<html>");
		out.println("<body>");
		out.println("<h2>Hello there, here is our second web app running on the new WildFly Server <br>");
		out.println("Using a context root configuration to change the Application URI, see below some configurations!</h2>");
